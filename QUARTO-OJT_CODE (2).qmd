...
{\Large \bfseries On Job Training (OJT 2025)}\\[0.4cm]
...
\textnormal{Prof. Amiya Ranjan Bhowmick (ICT Mumbai)}\\
...
\noindent
I hereby declare that the work presented in this report titled \textbf{“Expenditure Modelling and Transformation”} is my original contribution, carried out as part of my On-the-Job Training (OJT).This work has not been submitted elsewhere for the award of any academic degree or diploma. All sources used have been properly acknowledged and cited.
...
\includegraphics[width=2.2cm]{train_test.JPG}
...
- James, G., Witten, D., Hastie, T., & Tibshirani, R. (2021). **An Introduction to Statistical Learning: With Applications in R** (3rd ed.). Springer.

- Hastie, T., Tibshirani, R., & Friedman, J. (2009). **The Elements of Statistical Learning: Data Mining, Inference, and Prediction** (2nd ed.). Springer.

- Boehmke, B. E., & Greenwell, B. M. (2019). **Hands‑On Machine Learning with R**. Chapman & Hall/CRC.
